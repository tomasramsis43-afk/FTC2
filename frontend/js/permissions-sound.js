...
// يرسل تنبيه إيميل فوري للإدارة (ADMIN_ALERT_EMAILS على السيرفر)، مقتصر على 3 أحداث فقط: إضافة
// عميل جديد، حذف عميل، تعديل قيمة مدفوعات عميل. المستلمون مُعرَّفون على السيرفر وليس هنا — نفس
