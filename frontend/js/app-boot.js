/* ============================================================
   ...
   مُدمجاً هناك رغم عدم علاقته بشاشة المشتريات إطلاقاً). كان هذا
   قد سبّب عطلاً كاملاً فى الإقلاع (showLicenseScreen/activateAndStart/
   ensureServerLoginThenStart وغيرها غير معرّفة وقت استدعاء boot.js
   لها) أثناء فترة تجربة تحميل موديول المشتريات كسولياً (تم إلغاء
   تلك الخاصية بالكامل لاحقاً — module-purchases.js يُحمَّل الآن
   أساسياً كالمعتاد فى app.html)، لكن يبقى فصل هذا المنطق هنا صحيحاً
   ومفيداً بغض النظر: توضيح المسؤوليات (إقلاع/ترخيص/دخول منفصل عن
   شاشة المشتريات). لا تغيير فى أي منطق أعمال هنا — نقل فقط. يجب أن
   يبقى هذا الملف محمّلاً قبل js/boot.js فى app.html.
   ============================================================ */
