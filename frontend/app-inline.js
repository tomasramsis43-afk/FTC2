...
const THEME_PRESETS = [
  ...
  { id:'skyblue', name:'أزرق سماوي هادئ', colors:{ navy:'#3A6EA5', navyDark:'#254A73', gold:'#7FA9C9', goldDark:'#5E88A8', goldSoft:'#AFCBE0', teal:'#4A8C8A', red:'#B0524A' } },
  { id:'earthbrown', name:'بني ترابي دافئ', colors:{ navy:'#6B4A34', navyDark:'#4A3021', gold:'#B08655', goldDark:'#8A6640', goldSoft:'#D4B78C', teal:'#5C7A5E', red:'#A8453A' } },
  { id:'royalpurple', name:'أرجواني ملكي هادئ', colors:{ navy:'#5B4B7A', navyDark:'#3D3155', gold:'#9B8AC4', goldDark:'#7A6BA0', goldSoft:'#C7BBE0', teal:'#5A7A78', red:'#A8504F' } },
  { id:'olivegreen', name:'أخضر زيتوني هادئ', colors:{ navy:'#5C6B3E', navyDark:'#3E4A29', gold:'#9B8B4A', goldDark:'#7A6C38', goldSoft:'#C4B87A', teal:'#4E7A6E', red:'#A34C3F' } },
  { id:'midnightrose', name:'كحلي منتصف الليل ونحاسي وردي', colors:{ navy:'#2C3E5C', navyDark:'#1A2740', gold:'#C08A7D', goldDark:'#9E685C', goldSoft:'#E0B8AC', teal:'#4A6B6E', red:'#A8544F' } }
];
